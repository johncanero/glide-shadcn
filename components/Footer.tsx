      ...
      <div className="pt-16 mt-16 bg-neutral-900 lg:px-[200px]">
        <div className="md:flex-wrap lg:flex-nowrap lg:flex lg:justify-between">
          <div className="lg:max-w-lg">
            <p className="text-3xl font-semibold text-center text-white mx-14 md:mx-32 lg:mx-0 lg:text-left md:text-5xl lg:text-6xl">Sign up and Scoot off today</p>
          </div>
        ...
        <div className="mt-20">
          <Image
            src='/images/patterns/semi-circles.png'
            alt='semi-circles'
            width={1500}
            height={1500}
            className="mx-auto"
